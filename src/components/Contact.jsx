...
function Footer() {
  ...
  return (
  <section className='h-[94vh] xl:h-[100vh] lg:mt-20 xl:mt-28 lg:h-[100vh] bg-contactBG bg-cover' id="contact">
    <h1 className='text-center lg:mb-16 mb-0'>
        <p className='text-slate-600 font-semibold lg:mb-2 lg:text-lg text-xs font-poppins'>Get In Touch</p>
        <p className='font-bold lg:text-6xl text-4xl mb-8 lg:mb-0 font-poppins uppercase'>Contact</p>
    </h1>
    <div data-aos='fade-up' className="py-8 lg:py-16 px-6 lg:mx-auto mx-auto lg:max-w-[60%] sl:max-w-[1000px] sm:max-w-[600px] lg:mt-10 sl:mt-5 sm:mt-5 sm:mb-5 mt-5 mb-5 sl:mb-5 md:mb-10 lg:rounded-xl bg-white lg:border-2 lg:border-r-8 lg:border-b-4 border-black">

...
function Projects() {
  ...
  return (
    <section id='Projects' className='h-[160vh] w-auto lg:mt-40 mt-20'>
      <div>
      ...
      <div className='flex flex-col lg:gap-10'>
        {proj.map((item) => (
          <Card key={item.id} className='flex mx-auto blur-background h-100 lg:w-[100%] w-[80%] py-20'>
            <CardBody>
              ...
              >
                ...
                <div className='flex flex-col gap-5 lg:w-[60%] w-[100%] mx-auto text-center z-50'>
                  <p className='font-extrabold lg:text-lg text-sm'>{item.title}</p>
                  ...
                  {item.stack.map((stack, index) => (
                    <div key={index} className='lg:flex'>
                      <Chip value={stack} className="rounded-ful bg-black lg:px-3 lg:py-2 py-1  lg:text-[10px] text-[7px]" />
                    </div>
                  ))}
                  </div>

...
function Hero() {
  ...
  return (
    <section className='grid grid-cols-1 lg:grid-cols-2 lg:h-[40vh] sm:h-auto h-[65vh]  lg:mt-8 sm:mt-20 mt-28 lg:ml-16 mb-40' id='hero'>
         <div data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-duration="800" className="lg:py-20 sm:py-0 lg:mt-12 sm:mt-20 text-start lg:ml-20 ml-10 justify-start font-poppins lg:h-100 h-20 lg:w-full">
                ...
                <Typed className="z-0 lg:text-5xl sm:text-4xl text-2xl font-bold bg-clip-text text-black" strings={['Front-End Web Developer', 'React Developer']}  typeSpeed={40 }backSpeed={50}
                 loop />
         <div className='flex py-5' data-aos='fade-up' >   
               ...
               <Tooltip content="Facebook" placement="bottom-end" className="text-black bg-slate-400 px-3 font-poppins font-bold" animate={{ mount: { scale: 1, y: 5 },unmount: { scale: 0, y: 0 },}}><a href='https://www.facebook.com/Matthew.santos1202/' target="_blankFB" rel="noopener noreferrer" onClick={handleFbLink}><AiFillFacebook className='transition duration-300 transform hover:scale-125' size={32} /> </a></Tooltip>
                ...
                <h1 className="z-49 lg:text-md sm:text-lg text-sm text-slate-500 font-bold lg:mt-3 lg:ml-0.5">" Designing the Web, Illuminating Your Ideas. "</h1>
    ...
    <div data-aos='fade-down' data-aos-duration='1000' className='lg:py-0 z-0 lg:mt-0 mt-44 lg:ml-4 ml-6 lg:max-w-[680px] sm:max-w-auto max-w-auto lg:h-80 lg:mb-0 sm:mb-80 mb-40 sm:h-auto'>
    ...
    <div className='absolute bottom-8 left-1/2 transform -translate-x-1/2 -translate-y-1/2"'>
      <div data-aos='fade-down' data-aos-duration='1400' className='md:flex lg:flex hidden'>
          <Lottie animationData={scrollAnimation} className='lg:h-28 md:h-40 z-50'/>
      </div>
    </div> 
  </section>

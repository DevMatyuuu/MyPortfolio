    ...
    <section className='grid grid-cols-1 md:grid-cols-2 md:h-100 sm:h-auto h-auto mt-20 md:ml-10' id='hero'>
         ...
         <div className='flex py-5' data-aos='fade-up' >   
          ...
          <div className="md:py-1 py-2 text-start justify-start">
               <Button className="middle none center mr-3 rounded-md border md:mt-10 sm:mt-5 mt-5 border-black md:py-4 md:px-9 py-3 px-3 font-sans md:text-md text-xs font-bold uppercase text-black transition-all hover:opacity-75  active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none hover:bg-slate-300"
